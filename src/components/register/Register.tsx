            ...
            <div className='right'>
                ...
                <div className="form">
                    <form onSubmit={(e) => formSubmit(e)}>
                        <input type="text" placeholder='Full Name' className='inputData' value={name} onChange={(e) => setName(e.target.value)} autoComplete="name" />
                        <input type="email" placeholder='Email' className='inputData' value={email} onChange={(e) => setEmail(e.target.value)} autoComplete="email" />
                        <input type="password" placeholder='Password' className='inputData' value={password} onChange={(e) => setPassword(e.target.value)} autoComplete="new-password" />
                        ...
                        <p>Do you any account? <Link to={'/login'}>Login</Link></p>
                    </form>
